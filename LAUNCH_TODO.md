...
**Run now (2026-09-14):**
- `supabase/v1_5_backfill_profiles.sql` in the Supabase SQL Editor: 8 of 17 accounts have no profile row and cannot load the app on older APKs (the new app/backend repairs an account on sign-in, but the SQL fixes everyone at once).
