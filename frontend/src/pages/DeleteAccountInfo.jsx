            ...
            <div className="mx-auto max-w-2xl">
                ...
                <section className="mt-8 space-y-3 text-sm leading-7">
                    ...
                    <ul className="list-disc space-y-1 pl-5">
                        ...
                        <li>Your recurring-payment audit choices and expected-debit records, and your Vittova Pro purchase records</li>
                        <li>Your sponsored-challenge enrolments, completions and the vouchers linked to you</li>
                    </ul>
                </section>
                ...
                <section className="mt-8 space-y-3 text-sm leading-7">
                    ...
                    <ul className="list-disc space-y-1 pl-5">
                        ...
                        <li>A voucher that was already given out stays marked as issued, without any link to you, so it can never be given out twice.</li>
                        <li>Deleting your account does not cancel a Google Play subscription. If you pay for Vittova Pro, cancel it in Google Play first.</li>
                    </ul>
                </section>
