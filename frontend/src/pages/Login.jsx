...
export default function Login() {
    ...
    return (
        <AuthLayout eyebrow="WELCOME BACK">
            <div className="flex flex-col gap-6" aria-labelledby="login-title">
                {/* Header */}
                <div>
                    <p className="text-xs font-bold tracking-wider uppercase text-lime-300">WELCOME BACK</p>
                ...
                {!showEmailForm ? (
                    ...
                    <>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-[10px] font-bold tracking-wider uppercase text-zinc-500">EMAIL LOGIN</span>
                            <div className="h-px flex-1 bg-white/10" />
                        </div>
