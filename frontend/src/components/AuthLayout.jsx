...
export default function AuthLayout({ children, eyebrow = 'YOUR MONEY, IN FLOW' }) {
    return (
        <main className="relative min-h-screen overflow-hidden bg-[#080a08] px-4 py-5 text-white sm:px-6 sm:py-8">
            ...
            <div className="relative mx-auto grid min-h-[calc(100vh-2.5rem)] max-w-6xl overflow-hidden rounded-[2rem] border border-white/10 bg-[#0d100d]/95 shadow-2xl shadow-black/50 lg:grid-cols-[1.08fr_.92fr]">
                <aside className="relative hidden overflow-hidden border-r border-white/10 bg-[#121713] p-10 lg:flex lg:flex-col">
                    ...
                    <div className="my-auto max-w-md">
                        <p className="mb-5 text-[11px] font-bold tracking-[.2em] text-lime-300">{eyebrow}</p>
                        <h2 className="text-5xl font-extrabold leading-[.98] tracking-tight">A clearer view of every <span className="text-lime-400">rupee.</span></h2>
                    ...
                    <p className="text-xs text-zinc-500">Built for your everyday money moments.</p>
                </aside>
                <section className="flex min-h-full items-center justify-center p-5 sm:p-10 lg:p-12">
